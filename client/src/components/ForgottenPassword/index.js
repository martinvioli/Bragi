        ...
        <div className={styles.form}>
          ...
          >
            <p style={{ fontWeight: "bold", marginLeft: "15px" }}>
              Enter your email in order to resert your password
            </p>
          ...
          <Modal centered isOpen={showModal}>
            ...
            >
              ...
              <p className={styles.text}>
                We have sent you an email with a code to reset your password. If
                you can't find it, be sure to check your spam. Please, keep it,
                you should use it again later.
              </p>
              <FormGroup className="position-relative">
                <Input
                  type="text"
